      ...
      <main className="bg-white">
        ...
        <section className="bg-[#EDE8DE] pt-32 pb-20">
          <div className="mx-auto max-w-3xl px-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold leading-tight text-[#1C1B18] text-balance mb-6">
              What Is The Human Alignment Problem?
            </h1>
            <p className="text-xl leading-relaxed text-[#1C1B18] opacity-75">
        ...
        <article className="py-24">
          <div className="mx-auto max-w-3xl px-6">
            ...
            <p className="text-lg font-semibold text-[#1C1B18] mb-2">The work cannot be outsourced:</p>
            ...
            <div className="bg-[#EDE8DE] rounded-2xl border-2 border-[#1C1B18] p-8 my-10">
              <h3 className="text-xl font-bold text-[#1C1B18] mb-4">The Hidden Gap</h3>
              <p className="text-lg leading-relaxed text-[#1C1B18] opacity-80 mb-4">
                My book — <em>The Hidden Gap: Solving the Human Alignment Problem Behind Conflict, Behaviour and Culture</em> — is out now.
              </p>
              <p className="text-[#1C1B18] opacity-80 mb-2">In it, I explore:</p>
              <ul className="flex flex-col gap-2 mb-6">
                <li className="flex gap-2 items-start text-[#1C1B18] opacity-80">
              ...
              <a
                href="/book"
                className="inline-flex items-center justify-center rounded-md bg-[#1b4b80] px-6 py-3 text-[#EDE8DE] font-semibold hover:bg-[#163C66] transition-colors"
              >
                Buy Now →
              </a>
            </div>
          ...
          <div className="mx-auto max-w-3xl px-6">
            ...
            <div className="grid gap-6">
              ...
              >
                ...
                <h4 className="font-bold text-[#1C1B18] group-hover:text-[#1b4b80] transition-colors">
