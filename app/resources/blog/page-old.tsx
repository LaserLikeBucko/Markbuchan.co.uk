          ...
          <div className="mx-auto max-w-4xl px-6">
            ...
            <div className="flex flex-col gap-6">
              ...
              <a
                ...
                className="flex flex-col md:flex-row gap-6 rounded-2xl border-2 border-[#111110] bg-white p-8 hover:border-[#ff3131] transition-colors group"
              >
                <div className="flex-1">
                  ...
                  <h2 className="text-2xl font-bold text-[#111110] group-hover:text-[#ff3131] transition-colors mb-3">
                ...
                <div className="flex items-center md:items-end">
                  <span className="text-sm font-semibold text-[#111110] group-hover:text-[#ff3131] transition-colors whitespace-nowrap">
                    Read article →
                  </span>
                </div>
              </a>
              ...
              <div className="flex flex-col md:flex-row gap-6 rounded-2xl border-2 border-dashed border-[rgba(17,17,16,0.2)] bg-white p-8 opacity-60">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-3">
                  ...
                  <h2 className="text-2xl font-bold text-[#111110] mb-3">
              ...
              <div className="flex flex-col md:flex-row gap-6 rounded-2xl border-2 border-dashed border-[rgba(17,17,16,0.2)] bg-white p-8 opacity-60">
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Why "this is a safe space" is often the least safe thing a leader can say — and what actually creates the conditions where honesty becomes possible. On the gap between declared safety and operating reality.
                  </p>
                </div>
                <div className="flex items-center md:items-end">
                  <span className="text-sm font-semibold text-muted-foreground whitespace-nowrap">
