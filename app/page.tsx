    ...
    <>
      ...
      <main className="bg-white">
        <section className="relative overflow-hidden pt-24 pb-16">
          <div className="pointer-events-none absolute inset-x-0 top-0 h-[400px] bg-[#F6F1E8]" />
        ...
        <section className="pb-20">
          <div className="mx-auto max-w-4xl px-6 text-center">
            <h1 className="mx-auto max-w-2xl text-2xl md:text-4xl font-semibold leading-snug text-stone-900">
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-3">
              <div className="flex h-full flex-col rounded-2xl border border-stone-200 bg-[#F6F1E8] p-8 shadow-sm">
                <div className="min-h-[140px]">
                  <h3 className="text-2xl font-semibold text-stone-900">Book</h3>
        ...
        <section className="py-20">
          <div className="mx-auto max-w-5xl px-6 grid gap-10 md:grid-cols-[1.1fr_0.9fr] items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl md:text-4xl font-semibold text-stone-900">
                The Hidden Gap
              </h2>
              ...
              <a
                href="/book"
                className="mt-8 inline-flex items-center rounded-md border border-stone-300 px-5 py-3 text-stone-800 hover:bg-stone-100"
              >
                Learn more about the book
              </a>
            </div>

            <div className="mx-auto max-w-xs overflow-hidden rounded-lg border border-stone-200 bg-white shadow-sm">
              <Image
                src="/images/book-cover.jpg"
