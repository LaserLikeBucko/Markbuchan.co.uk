      ...
      <main className="bg-white">
        ...
        <section className="bg-[#111110] py-16">
          <div className="mx-auto max-w-2xl px-6 text-center">
            ...
            <p className="mt-4 text-sm text-white opacity-40">— The Hidden Gap, Mark Buchan MSc</p>
          </div>
        </section>

        {/* THE TOOL */}
        <section id="diagnostic-tool" className="py-20 border-t-4 border-dashed border-[#111110]">
          <div className="mx-auto max-w-3xl px-6 text-center mb-12">
            <h2 className="text-2xl font-bold text-[#111110] mb-4">
              Your Hidden Gap Diagnostic
            </h2>
            <p className="text-muted-foreground">
              Work through the six steps below. Your profile appears at the end.
            </p>
          </div>

          {/* Embed the diagnostic tool */}
          <div className="mx-auto max-w-2xl px-6">
            <iframe
              src="/diagnostic-tool.html"
              className="w-full rounded-2xl border-2 border-[#111110]"
              style={{ minHeight: '800px', border: 'none' }}
              title="The Hidden Gap Diagnostic Tool"
            />
          </div>
        </section>
        ...
        <section className="bg-[#ffff00] py-20 border-t-4 border-dashed border-[#111110]">
          <div className="mx-auto max-w-3xl px-6 text-center">
            ...
            <p className="text-sm text-[#111110] opacity-50 mb-8">Use this code for 25% off at launch.</p>
            <a
              href="/book"
              className="inline-flex items-center rounded-md bg-[#111110] px-8 py-4 text-[#ffff00] text-lg font-semibold hover:bg-[#ff3131] transition-colors"
            >
